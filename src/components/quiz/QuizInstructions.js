        ...
        <div className="instructions container">
            ...
            <ul className="browser-default" id="main-list">
                ...
                <li>
                    ...
                    will remove 2 wrong answers, leaving the correct and wrong answer<br />
                ...
                <li>
                    ...
                    answer. You can use as many hints as possible on a single question.<br />
                    <img src={hints} alt="Quiz App hints example" />
                </li>
                <li>
                    Feel free to quit (or retire from) the game at any time. In that case your
