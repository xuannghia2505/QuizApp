        ...
        return (
            <Fragment>
                ...
                <Fragment>
                    ...
                    <audio ref={this.wrongSound} id="wrong-sound" src={wrongNotification}></audio>
                ...
                <div className="question">
                    ...
                    <div className="lifeline-container">
                        <p>
                            <span onClick={this.handleFiftyFifty} className="mdi mdi-set-center mdi-200px lifeline-icon">
                                <span className="lifeline">{fiftyFifty}</span>
                            </span>
                        </p>
                        <p>
                            <span onClick={this.handleHints} className="mdi mdi-lightbulb-on-outline mdi-200px lifeline-icon">
                    ...
                    <div className="timer-container">
                        <p>
                            ...
                            <span className="right">{time.minutes}:{time.seconds}<span className="mdi mdi-clock-outline mdi-200px lifeline-icon"></span></span>
                        </p>
                    </div>
